This is a repo intended to be used as a boilerplate, based on an excellent React+Redux+Redux-Saga tutorial one can find here: https://scotch.io/tutorials/build-a-media-library-with-react-redux-and-redux-saga-part-1
